'''
    The original file of this is part of PM4Py (More Info: https://pm4py.fit.fraunhofer.de).
    ...
    Export a Purpose Limitating Petri Net to a XML tree
    Code fully copied from PM4Py (https://github.com/pm4py/pm4py-core/blob/74eb2a5977db7f28183ac74dbb5bb6f59570d479/pm4py/objects/petri_net/exporter/variants/pnml.py),
    only modification in line 183
    
    The modified file is also part of augPM
...
def export_petri_tree(
    ...
    for arc in petrinet.arcs:
        ...
        if type(arc.source) is PlaceIot:                                                                                  
